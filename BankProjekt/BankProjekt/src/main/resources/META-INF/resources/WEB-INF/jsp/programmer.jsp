...
<%@ include file="common/navigation.jsp" %>
  ...
  <hr>
  <h1>Enter Programmer Details:</h1>
  
  <form:form method="post" modelAttribute="programmer">
		<fieldset class="mb-3">
		...
		<fieldset class="mb-3">
			...
			<form:input type="text" path="tasks" required="required" />
			<form:errors path="tasks" cssClass="text-warning" />
		</fieldset>
		<fieldset class="mb-3">
